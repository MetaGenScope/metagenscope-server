...
from app.display_modules.sample_similarity.sample_similarity_tasks import get_clean_samples
...
class TestSampleSimilarityTasks(BaseTestCase):
    ...
    def test_clean_samples(self):
        """Ensure clean_samples method adds missing features to all samples."""
    ...
    def test_clean_zeroed_samples(self):
        """Ensure clean_samples method removes features below threshold."""
